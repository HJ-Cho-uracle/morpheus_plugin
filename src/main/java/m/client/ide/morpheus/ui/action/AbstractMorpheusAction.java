...
public abstract class AbstractMorpheusAction extends AnAction {
    static final Key<Object> customComponentKey = Key.create("customComponent");

    public AbstractMorpheusAction() {
        super();
    }

    public AbstractMorpheusAction(String text) {
        super(text);
    }
    ...
    protected static void updateVisibility(final @NotNull Presentation presentation, boolean isMorpheus) {
        final JComponent component = (JComponent) presentation.getClientProperty(customComponentKey);
        if (component != null) {
