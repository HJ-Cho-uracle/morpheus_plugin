...
public class StringUtil {
    ...
    public static String getPrettyContents(String contents) {
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            Object readValue = objectMapper.readValue(contents, Object.class);
            String prettyText = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(readValue);
            return prettyText;
